    ...
    return (
        <section>
            <Helmet>
                ...
                <meta property="og:url" content="https://evaluationz.com/ecommerce" />
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 pb-30">
                            <div className="about-section-item about-item-image text-md-left text-center">
                                <img src="images/industries/ecommerce/image-1.png" alt="shape" className="blue-image-left shadow-2xl"/>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 pb-30">
                            <div className="about-section-item about-item-details">
                                <div className="section-title section-title-left text-start">
                                    <h1 className="text-white font-weight-bolder">Screening when every individual is your customer touchpoint</h1>
                                </div>
                            </div>
                        </div>
                    </div>
